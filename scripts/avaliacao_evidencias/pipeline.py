...
com os orquestradores (``run_avaliacao_evidencias_v2.py``) e os eventos de log
JSONL esperados.
...
def main(argv: list[str] | None = None) -> int:
    ...
    # Classificar e contar analises avaliaveis vs sem evidencias inaplicaveis de antemao
    total_avaliaveis = 0
    total_sem_evidencias = 0
    ...
    log_event(
        ...
        total_avaliaveis=total_avaliaveis,
        total_sem_evidencias=total_sem_evidencias,
