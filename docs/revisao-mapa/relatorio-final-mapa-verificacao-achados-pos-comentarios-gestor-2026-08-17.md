...
| PA03/S3.5 | q2102C, q2802C, q2802D e q2804B; “vínculo com orçamento e contratações” | `AV20 \| AV98`; “Plano de TIC não utilizado como referência para a elaboração da proposta orçamentária e do plano de contratações” | Elimina o bis in idem com o achado de contratações e torna a situação aderente ao conteúdo efetivamente verificado por q2102ext[C], sem exigir estimativa orçamentária ou memória de cálculo não avaliadas pelo questionário. |
...
| Q6 | “A organização adota controles mínimos na fase preparatória das contratações de TIC, com processo definido e análise técnica pela unidade competente?” | “A organização adota processo formal e padronizado para a fase preparatória das contratações de TIC, com responsabilidades definidas, análise técnica pela área de TIC e alinhamento aos instrumentos de planejamento?” | Substitui expressão genérica por requisitos verificáveis e cobre os quatro eixos das situações S6.1 a S6.4. |
